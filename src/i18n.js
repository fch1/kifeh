...
const CATALOG = {
  fr: {
    ...
    email_confirm_subject: 'Confirmez vos alertes Kifeh',
    email_confirm_body: 'Vous avez demandé à recevoir par e-mail les incidents signalés dans votre zone sur Kifeh. Un clic pour confirmer :',
    email_confirm_link: 'Activer mes alertes',
    email_ignore_note: 'Si vous n’êtes pas à l’origine de cette demande, ignorez simplement ce message — rien ne sera activé.',
    email_view_link: 'Voir l’incident sur Kifeh',
    email_unsub_note: 'Ne plus recevoir ces alertes (désinscription en un clic)',
    email_digest_subject: 'Votre brief Kifeh du matin — l’état de votre zone',
    email_digest_heading: 'L’état de votre zone ce matin',
    email_digest_active: '{n} incident(s) en cours dans votre zone suivie :',
    email_digest_vigilance: 'Vigilance Météo-France : {n} département(s) en alerte orange ou rouge.',
    type_fire: 'incendie', type_electricity: 'coupure d’électricité',
    type_water: 'coupure d’eau', type_internet: 'panne internet', type_other: 'autre incident',
    email_alerts_unavailable: 'Les alertes e-mail ne sont pas disponibles pour le moment.',
    email_check_inbox: 'Vérifiez votre boîte mail : un e-mail de confirmation vient de vous être envoyé.',
    email_already_confirmed: 'Vos alertes e-mail sont déjà actives — la zone a été mise à jour.',
    email_send_failed: 'L’e-mail de confirmation n’a pas pu être envoyé. Réessayez plus tard.',
    email_confirmed_title: 'Alertes activées ✓',
    email_confirmed_body: 'Vous recevrez un e-mail quand un incident sera signalé dans votre zone. Chaque message contient un lien de désinscription.',
    email_link_invalid: 'Ce lien n’est plus valable.',
    email_unsub_done: 'Désinscription effectuée — vous ne recevrez plus d’alertes.',
    email_alert_body: 'Un incident vient d’être signalé dans votre zone d’alerte. Ouvrez Kifeh pour voir la situation, confirmer si vous êtes concerné ou indiquer votre statut de sécurité.',
    email_footer_notice: 'Kifeh est une initiative citoyenne indépendante — jamais une source officielle. En cas de danger immédiat, appelez les numéros d’urgence officiels.',
  ...
  ar: {
    ...
    email_confirm_subject: 'أكّد تنبيهات كيفاه',
    email_confirm_body: 'طلبت تلقّي الحوادث المبلغ عنها في منطقتك عبر البريد الإلكتروني على كيفاه. نقرة واحدة للتأكيد:',
    email_confirm_link: 'تفعيل تنبيهاتي',
    email_ignore_note: 'إن لم تكن صاحب هذا الطلب، تجاهل هذه الرسالة — لن يُفعَّل أي شيء.',
    email_view_link: 'عرض الحادث على كيفاه',
    email_digest_subject: 'موجز كيفاه الصباحي — حالة منطقتك',
    email_digest_heading: 'حالة منطقتك هذا الصباح',
    email_digest_active: '{n} حادث جارٍ في منطقتك المتابَعة:',
    email_digest_vigilance: 'يقظة Météo-France: {n} ولاية في إنذار برتقالي أو أحمر.',
    type_fire: 'حريق', type_electricity: 'انقطاع كهرباء',
    type_water: 'انقطاع ماء', type_internet: 'عطل إنترنت', type_other: 'حادث آخر',
    email_unsub_note: 'إيقاف هذه التنبيهات (إلغاء الاشتراك بنقرة واحدة)',
    email_alerts_unavailable: 'تنبيهات البريد الإلكتروني غير متاحة حاليًا.',
    email_check_inbox: 'تحقق من بريدك: أُرسلت رسالة تأكيد للتو.',
    email_already_confirmed: 'تنبيهاتك مفعّلة مسبقًا — حُدِّثت المنطقة.',
    email_send_failed: 'تعذّر إرسال رسالة التأكيد. أعد المحاولة لاحقًا.',
    email_confirmed_title: 'تم تفعيل التنبيهات ✓',
    email_confirmed_body: 'ستتلقى بريدًا عند التبليغ عن حادث في منطقتك. كل رسالة تحتوي رابط إلغاء الاشتراك.',
    email_link_invalid: 'هذا الرابط لم يعد صالحًا.',
    email_unsub_done: 'تم إلغاء الاشتراك — لن تتلقى تنبيهات بعد الآن.',
    email_alert_body: 'أُبلغ للتو عن حادث في منطقة تنبيهاتك. افتح كيفاه لرؤية الوضع، أو تأكيد أنك معني، أو تحديد حالة سلامتك.',
    email_footer_notice: 'كيفاه مبادرة مدنية مستقلة — ليست مصدرًا رسميًا أبدًا. في حالة خطر فوري، اتصل بأرقام الطوارئ الرسمية.',
