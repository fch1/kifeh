...
const I18N = {
  fr: {
    ...
    counter_none_sat: 'Aucun signalement citoyen — activité satellite détectée',
    ...
    layers_sub: 'Chaque couche dit sa source et son heure — activez ce qui vous parle.',
    lgrp_observed: 'Ce qui est observé',
    lgrp_published: 'Contours publiés',
    lgrp_conditions: 'Conditions',
    lgrp_context: 'Contexte',
    layers_absent_note: 'Une couche absente ici n’existe pas encore pour ce territoire — Kifeh le dit plutôt que de l’inventer.',
    lay_fresh: 'à jour', lay_delayed: 'retardée', lay_stale: 'ancienne',
    wx_layer_refresh_failed: 'Impossible de rafraîchir la météo pour l’instant — dernier voile connu conservé.',
    replay_btn: 'Voir l’évolution',
    replay_banner: 'Vous regardez le passé — {t}',
    replay_live_hint: '· toucher pour revenir au direct',
    replay_live: '● Direct',
    replay_play: 'Lecture', replay_pause: 'Pause',
    replay_empty: 'Rien à rejouer ici sur cette fenêtre — aucune détection ni contour connu dans cette vue.',
    replay_win_h: '{n} h', replay_win_10d: '10 j',
    replay_window_aria: 'Fenêtre de relecture (24 h, 72 h ou 10 jours)',
    replay_share: 'Partager cet instant',
    replay_share_copied: 'Lien copié ✓',
    smoke_layer_name: 'Simulation indicative de fumée',
    smoke_layer_sub: 'Ni observation, ni qualité de l’air — construction FRP × vent, 6 h max.',
    smoke_note: 'Simulation indicative de fumée — ni observation, ni qualité de l’air.',
    fc_conf_high: 'Confiance élevée',
    fc_conf_medium: 'Confiance moyenne',
    fc_conf_trend: 'Tendance incertaine',
    fc_detail_tmax: 'Température max', fc_detail_hum: 'Humidité min',
    fc_detail_wind: 'Vent max', fc_detail_gusts: 'Rafales max',
    fc_detail_rain: 'Pluie cumulée', fc_detail_valid: 'Jour concerné',
    fc_detail_fetched: 'Données récupérées', fc_day_hint: 'Toucher un jour pour le détail',
    replay_bar_aria: 'Relecture des 72 dernières heures',
    replay_slider_aria: 'Position dans le temps',
    ...
    ob_map_title: 'Carte en quasi temps réel',
    ...
    // « Depuis votre dernière visite » — delta honnête, jamais gonflé.
    slv_title: 'Depuis votre dernière visite',
    slv_inc_one: '1 nouveau signalement citoyen',
    slv_inc_n: '{n} nouveaux signalements citoyens',
    slv_none: 'Aucune nouvelle information depuis votre dernière visite.',
    slv_see_zones: 'Voir mes zones suivies',
    wx_layer_stale: 'Météo de {t} — la mise à jour est momentanément indisponible.',
    sat_age_legend: 'Netteté du marqueur : observation < 6 h · 6-24 h · 24-72 h',
    firemode_title: 'Mode feux',
    firemode_understand: 'Comprendre',
    firemode_explore: 'Calques',
    fc_title: 'Conditions favorisant les feux',
    fc_today: 'Aujourd’hui',
    fc_gusts: 'rafales',
    fc_hum: 'hum. min',
    fc_7d: 'Voir les 7 jours',
    fc_trend: 'tendance',
    fc_src: 'Source : {s}',
    vig_local_title: 'Autour de la zone consultée',
    vig_none_local: 'Aucune vigilance dans la zone consultée.',
    vig_rest_toggle: 'Voir le reste de la France ({n})',
    hero_collapse: 'Réduire la carte de situation',
    hero_expand: 'Développer la carte de situation',
    wx_legend_temp: 'Température de l’air (froid → chaud)',
    wx_legend_wind: 'direction du vent',
    wx_legend_at: 'AROME HD (Météo-France) via Open-Meteo · {t}',
  ...
  ar: {
    ...
    counter_none_sat: 'لا تبليغات من المواطنين — رُصد نشاط عبر الأقمار الاصطناعية',
    ...
    layers_sub: 'كل طبقة تُظهر مصدرها وساعتها — فعّلوا ما يناسبكم.',
    lgrp_observed: 'ما يُرصد',
    lgrp_published: 'حدود منشورة',
    lgrp_conditions: 'الظروف',
    lgrp_context: 'السياق',
    layers_absent_note: 'الطبقة الغائبة هنا غير متوفرة بعد لهذا البلد — كيفاه تقول ذلك بدل اختلاقها.',
    lay_fresh: 'محدّثة', lay_delayed: 'متأخرة', lay_stale: 'قديمة',
    wx_layer_refresh_failed: 'تعذّر تحديث الطقس حاليًا — أُبقي آخر غطاء معروف.',
    replay_btn: 'عرض التطوّر',
    replay_banner: 'أنتم تشاهدون الماضي — {t}',
    replay_live_hint: '· المسّ للعودة إلى المباشر',
    replay_live: '● مباشر',
    replay_play: 'تشغيل', replay_pause: 'إيقاف مؤقت',
    replay_empty: 'لا شيء لإعادة عرضه هنا خلال هذه الفترة — لا أرصاد ولا حدودًا معروفة في هذه المنطقة.',
    replay_win_h: '{n} س', replay_win_10d: '10 أيام',
    replay_window_aria: 'فترة إعادة العرض (24 س، 72 س أو 10 أيام)',
    replay_share: 'مشاركة هذه اللحظة',
    replay_share_copied: 'نُسخ الرابط ✓',
    smoke_layer_name: 'محاكاة إرشادية للدخان',
    smoke_layer_sub: 'ليست رصدًا ولا جودة هواء — تركيب من القدرة الإشعاعية والرياح، 6 ساعات كحد أقصى.',
    smoke_note: 'محاكاة إرشادية للدخان — ليست رصدًا ولا قياسًا لجودة الهواء.',
    fc_conf_high: 'ثقة عالية',
    fc_conf_medium: 'ثقة متوسطة',
    fc_conf_trend: 'اتجاه غير مؤكد',
    fc_detail_tmax: 'أقصى حرارة', fc_detail_hum: 'أدنى رطوبة',
    fc_detail_wind: 'أقصى رياح', fc_detail_gusts: 'أقصى هبّات',
    fc_detail_rain: 'أمطار متراكمة', fc_detail_valid: 'اليوم المعني',
    fc_detail_fetched: 'استُرجعت البيانات', fc_day_hint: 'المس يومًا لعرض التفاصيل',
    replay_bar_aria: 'إعادة عرض آخر 72 ساعة',
    replay_slider_aria: 'الموضع الزمني',
    ...
    ob_map_title: 'خريطة شبه لحظية',
    ob_map_body: 'شاهد الحرائق والانقطاعات والأعطال من حولك، بشكل شبه لحظي.',
    ...
    slv_title: 'منذ زيارتكم الأخيرة',
    slv_inc_one: 'تبليغ مواطن جديد واحد',
    slv_inc_n: '{n} تبليغات مواطنين جديدة',
    slv_none: 'لا معلومات جديدة منذ زيارتكم الأخيرة.',
    slv_see_zones: 'عرض مناطقي المتابَعة',
    wx_layer_stale: 'طقس الساعة {t} — التحديث غير متاح مؤقتًا.',
    sat_age_legend: 'وضوح العلامة: رصد أقل من 6 س · 6-24 س · 24-72 س',
    firemode_title: 'وضع الحرائق',
    firemode_understand: 'فهم الوضع',
    firemode_explore: 'الطبقات',
    fc_title: 'ظروف مساعدة على الحرائق',
    fc_today: 'اليوم',
    fc_gusts: 'هبّات',
    fc_hum: 'أدنى رطوبة',
    fc_7d: 'عرض الأيام السبعة',
    fc_trend: 'اتجاه',
    fc_src: 'المصدر: {s}',
    vig_local_title: 'حول المنطقة المستعرضة',
    vig_none_local: 'لا تحذيرات في المنطقة المستعرضة.',
    vig_rest_toggle: 'عرض بقية فرنسا ({n})',
    hero_collapse: 'تصغير بطاقة الوضع',
    hero_expand: 'توسيع بطاقة الوضع',
    wx_legend_temp: 'حرارة الهواء (بارد → حار)',
    wx_legend_wind: 'اتجاه الرياح',
    wx_legend_at: 'AROME HD (Météo-France) عبر Open-Meteo · {t}',
